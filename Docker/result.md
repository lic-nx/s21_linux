...
![](images/docker03UpdateUpgrade.png) \
...
![](images/dockerServerfinal03.png) \
nginx -s reload   \
curl localhost:81/
вывод результата. \
![результат вывода](images/helloWord.png)
## Part 4. Свой докер
...
(этот и последующие пункты запускаются с помощью run.sh . но на некоторых компьютерах это перестало работать хз почему)
...
Для работы этой части \
docker-compose build \
![](../src/images/06_build.png)
docker-compose up -d \
![](../src/images/06_up.png)
curl localhost:80 \
![](../src/images/06_done.png)